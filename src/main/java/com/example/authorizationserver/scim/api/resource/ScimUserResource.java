...
public class ScimUserResource extends ScimUserListResource {
    ...
    private Set<ScimGroupRefResource> groups = new HashSet<>();
    ...
    public ScimUserResource(ScimMetaResource meta, UUID identifier, String externalId, String userName, String familyName,
                            ...
                            Set<ScimGroupRefResource> groups, Set<String> entitlements, Set<String> roles,
    ...
    public Set<ScimGroupRefResource> getGroups() {
        return groups;
    }

    public void setGroups(Set<ScimGroupRefResource> groups) {
        this.groups = groups;
    }
